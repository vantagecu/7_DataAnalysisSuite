...
X_e_b4 = 0; % m
X_e_b5 = 0; % m
Y_e_b1 = (7+3/8) * inch_to_m; % m
Y_e_b2 = (15+7/8) * inch_to_m; % m
Y_e_b3 = (22.75+1+1/8) * inch_to_m; % m
Y_e_b4 = (22.75+6.5) * inch_to_m; % m
Y_e_b5 = (22.75+13) * inch_to_m; % m
...
X_e_c2 = 0; % m
X_e_c3 = 0; % m
Y_e_c1 = (4.25/2) * inch_to_m; % m
Y_e_c2 = (9.5+4.25/2) * inch_to_m; % m
Y_e_c3 = (18.75+4.25/2) * inch_to_m; % m
Z_e_c1 = 0; % m
Z_e_c2 = 0; % m
Z_e_c3 = 0; % m
...
Y_o_v = mean( data(:,7) / 1000 ); % m
Z_o_v = mean( data(:,8) / 1000 ); % m
...
X_v_c2 = X_b_c1 + X_v_b; % m
X_v_c3 = X_b_c1 + X_v_b; % m
Y_v_c1 = Y_b_c1 + Y_v_b; % m
Y_v_c2 = Y_b_c2 + Y_v_b; % m
Y_v_c3 = Y_b_c3 + Y_v_b; % m
